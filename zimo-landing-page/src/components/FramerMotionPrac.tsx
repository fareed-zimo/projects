...
const squareVariant = { hidden: { opacity: 0 }, show: { opacity: 1 } };

const svgIconVariants = {
  hidden: { opacity: 0, pathLength: 0, fill: "rgba(252, 211, 77, 0)" },
  show: { opacity: 1, pathLength: 1, fill: "rgba(252, 211, 77, 1)" },
};
...
const FramerMotionPrac = () => {
  ...
  return (
    <main className="flex flex-col gap-10 overflow-x-hidden bg-black">
      <section className="relative w-full h-full flex flex-col">
        ...
        >
          ...
          >
            <motion.div
              className="bg-rose-400 w-1/3 h-1/3 shadow-md rounded-lg"
              animate={{
                scale: [1, 2, 2, 1],
                rotate: [0, 90, 90, 0],
      ...
      <section className="flex flex-col gap-10 mb-10" ref={containerRef}>
        ...
        >
          ...
          ipsum reiciendis voluptas, amet aspernatur libero. Labore dignissimos
          impedit ipsum nam laudantium! Quos amet ipsam ea consequuntur eveniet
          exercitationem ab officiis.
        </motion.p>
        <motion.p
          className="text-slate-100 font-thin text-4xl w-1/2 mx-auto"
        ...
        >
          ...
          provident voluptas ex quos, placeat molestiae culpa velit rerum.
        </motion.p>
      </section>
    </main>
  );
